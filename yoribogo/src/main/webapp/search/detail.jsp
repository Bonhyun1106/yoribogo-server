...
<body>
	<span id="menubar">
	    ...
	    <div class="kby_wrapper">
	      ...
	      <form action="list.do" id="doSubmit">
	        <div id="kby_left-menu" class="kby_side-nav">
	          ...
	          <div class="kby_v-tab_container">
	            ...
	            <div id="kby_vtab2" class="kby_v-tab_content">
	              ...
	              <input type="radio" name="level" id="level5" />
	            ...
	            <div id="kby_vtab3" class="kby_v-tab_content">
	                <input type="radio" name="weather" id="weather1" />
	                <label for="weather1">맑음</label>
	                <input type="radio" name="weather" id="weather2" />
	                <label for="weather2">흐림/비</label>
	                <input type="radio" name="weather" id="weather3" />
	                <label for="weather3">눈</label>
	                <input type="radio" name="weather" id="weather4" />
	                <label for="weather4">더워요</label>
	                <input type="radio" name="weather" id="weather5" />
	                <label for="weather5">추워요</label>
	            </div>
	
	            <div id="kby_vtab4" class="kby_v-tab_content">
	                <input type="radio" name="country" id="country1" />
	                <label for="country1">한식</label>
	                <input type="radio" name="country" id="country2" />
	                <label for="country2">일식</label>
	                <input type="radio" name="country" id="country3" />
	                <label for="country3">중식</label>
	                <input type="radio" name="country" id="country4" />
	                <label for="country4">양식</label>
	                <input type="radio" name="country" id="country5" />
	                <label for="country5">동남아시아</label>
	                <input type="radio" name="country" id="country6" />
	                <label for="country6">기타아시아</label>
	                <input type="radio" name="country" id="country7" />
	            ...
	            <div id="kby_vtab7" class="kby_v-tab_content">
	                <input type="checkbox" name="4946" id="cb0" />
	                <label for="cb0">고열량</label>
	                <input type="checkbox" name="4947" id="cb1" />
	                <label for="cb1">당뇨병</label>
	                <input type="checkbox" name="4948" id="cb2" />
	                <label for="cb2">채식</label>
	                <input type="checkbox" name="4949" id="cb3" />
	                <label for="cb3">육식</label>
	                <input type="checkbox" name="4950" id="cb4" />
	                <label for="cb4">할랄</label>
	                <input type="checkbox" name="4951" id="cb5" />
	                <label for="cb5">임산부</label>
	                <input type="checkbox" name="4952" id="cb6" />
	                <label for="cb6">고염</label>
	                <input type="checkbox" name="4953" id="cb7" />
	                <label for="cb7">영유아</label>
	                <input type="checkbox" name="4954" id="cb8" />
	                <label for="cb8">패스트푸드</label>
	                <input type="checkbox" name="4955" id="cb9" />
	                <label for="cb9">견과류</label>
	                <input type="checkbox" name="4956" id="cb10" />
	                <label for="cb10">알러지 유발 식품</label>
	                <input type="checkbox" name="4957" id="cb11" />
	                <label for="cb11">고열량</label>
	                <input type="checkbox" name="4958" id="cb12" />
	                <label for="cb12">많이 매움</label>
	                <input type="checkbox" name="4959" id="cb13" />
